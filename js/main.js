...
$(".popup-you").click(function(){
    var video = document.getElementById('video');
    if($('.mfp').is(':hidden'))
    {
        $('.vedio-img').slideUp('fast');
        $('.zmdi-play-circle-outline').slideUp('fast');
        $('.zmdi-pause-circle-outline').slideDown('fast');
        $('.mfp').slideDown('slow');
        video.play();// 播放视频
    }else{
        $('.mfp').slideUp('slow');
        $('.zmdi-play-circle-outline').slideDown('fast');
        $('.zmdi-pause-circle-outline').slideUp('fast');
        video.pause();// 关闭视频
        $('.vedio-img').slideDown('fast');
    }
})